...
keys = ['title', 'price', 'price-drop', 'image-list', 'open-house-label', 'original-listing', 'Property-Summary', 'Property-Details', 'Description', 'Features', 'Price-History', 'Agent-Details']
main_list = []
for li in lis:
