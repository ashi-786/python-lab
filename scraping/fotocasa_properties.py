...
for i in range(1, 21):
    try:
        api_url = f"https://web.gw.fotocasa.es/v2/propertysearch/search/propertycoordinates?combinedLocationIds=724,0,0,0,0,0,0,0,0&culture=es-ES&includePurchaseTypeFacets=false&isMap=false&isNewConstructionPromotions=false&latitude=40&longitude=-4&pageNumber={i}&platformId=1&propertyTypeId=2&size=300&sortOrderDesc=true&sortType=scoring&transactionTypeId=1"
...
with open('fotocasa_properties1.json', 'w', encoding="utf-8") as f:     
